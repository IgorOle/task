...
<head>
    ...
    <script type="text/javascript" src="webjars/jquery-validation/1.19.0/jquery.validate.min.js" defer></script>
    <script type="text/javascript" src="webjars/jquery-validation/1.19.0/additional-methods.min.js" defer></script>
